...
* The original package name 'br.com.erudio.rest-with-spring-boot-java-erudio' is invalid and this project uses 'br.com.erudio.rest_with_spring_boot_java_erudio' instead.
